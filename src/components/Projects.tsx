...
const projects: Project[] = [
  {
    ...
    title: '3atik Store',
    image:'./atik.png',
    description: '"An elegant bilingual gift & personalized crafts store featuring curated collections, custom product options, and an intuitive checkout flow."',
  ...
  },
  {
    ...
    title: 'Farasha Store',
    image:'./farasha.png',
    description: '"A luxury bilingual jewelry & accessories e-commerce web app featuring interactive product catalogs, advanced filtering, and a seamless cart ordering flow."',
